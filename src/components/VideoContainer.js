...
const VideoContainer = () => {
  ...
  return (
    <div className="flex flex-wrap justify-between content-center items-center bg-gray-950 absolute top-11 px-2 md:left-16 md:mt-16 lg:mt-16 left-0 mt-16 w-auto">
